        ...
        <el-main style="padding: 0 0 0 10px; min-width: 0;">
            <div v-show="!editTestStepActivate" class="recordapi__header">
                <div class="recordapi__header" :style="{ flex: 1 }">
                    ...
                    <div class="recordapi__header--item">
                        <el-select v-model="selectUser" placeholder="创建人" filterable :style="{ width: '120px' }">
                            <el-option
                ...
                <div class="recordapi__header" :style="{ flex: 1 }">
                    ...
                    <div class="recordapi__header--item">
                        <el-button type="primary" v-loading="suite_loading" @click="handleClickRun">Send </el-button>
                    </div>
                </div>
            </div>
                        ...
                        >
                            <div class="test-list">
                                ...
                                >
                                    ...
                                    >
                                        <span class="block-method block_method_test block_method_color"
                                            >Step_{{ index }}</span
                                        >
