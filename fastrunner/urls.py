...
urlpatterns = [
    ...
    # 项目相关接口地址
    path(
        "project/", project.ProjectView.as_view({"get": "list", "post": "add", "patch": "update", "delete": "delete"})
    ),
    ...
    path("debugtalk/", project.DebugTalkView.as_view({"patch": "update", "post": "run"})),
    # 二叉树接口地址
    ...
    path(
        "api/<int:pk>/",
        api.APITemplateView.as_view({"delete": "delete", "get": "single", "patch": "update", "post": "copy"}),
    ),
    path(
        "api/tag/",
    ...
    # test接口地址
    path("test/", suite.TestCaseView.as_view({"get": "get", "post": "post", "delete": "delete"})),
    path(
        "test/<int:pk>/",
        suite.TestCaseView.as_view(
            {
    ...
    # config接口地址
    path("config/", config.ConfigView.as_view({"post": "add", "get": "list", "delete": "delete"})),
    path(
        "config/<int:pk>/",
        config.ConfigView.as_view({"post": "copy", "delete": "delete", "patch": "update", "get": "all"}),
    ),
    path("variables/", config.VariablesView.as_view({"post": "add", "get": "list", "delete": "delete"})),
    path("variables/<int:pk>/", config.VariablesView.as_view({"delete": "delete", "patch": "update"})),
    # run api
    ...
    # 报告地址
    path("reports/", report.ReportView.as_view({"get": "list"})),
    path("reports/<int:pk>/", report.ReportView.as_view({"delete": "delete", "get": "look"})),
    path("host_ip/", config.HostIPView.as_view({"post": "add", "get": "list"})),
    path("host_ip/<int:pk>/", config.HostIPView.as_view({"delete": "delete", "patch": "update", "get": "all"})),
]
